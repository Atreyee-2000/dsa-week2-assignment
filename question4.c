//4. Write a program that reads two 2D metrices from the console, verifies if metrics multiplication is possible or
//not. Then multiplies the metrices and prints the 3rd metrics.
